  ...
  const DEFAULT_BUILTIN_PROVIDERS: BuiltinProviderConfig[] = [
    {
      ...
      supportedModels: ['deepseek-v4-pro', 'deepseek-v4-pro-think', 'deepseek-v4-pro-search', 'deepseek-v4-pro-think-search', 'deepseek-v4-flash', 'deepseek-v4-flash-think', 'deepseek-v4-flash-search', 'deepseek-v4-flash-think-search', 'deepseek-v4-vision', 'deepseek-chat', 'deepseek-reasoner', 'DeepSeek-R1', 'DeepSeek-Search', 'DeepSeek-R1-Search'],
      modelMappings: {
        ...
        'deepseek-v4-vision': 'deepseek-chat',
        'deepseek-v4-vision-search': 'deepseek-chat',
